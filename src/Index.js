  ...
  return (
    <div className='m-6 flex flex-col justify-center content-center items-center md:flex-row text-center text-white lg:mt-12 sm: mt-36'>
      ...
      <div className=''>
        ...
        <div className='text-xl md:text-7xl'><span className='text-green-500 '>{6000-totalCoins}</span> Coins and <span className='text-green-500'>{Math.floor((6000-totalCoins)/11)}</span>  Days Left</div>
      </div>
    </div>
  )
}
